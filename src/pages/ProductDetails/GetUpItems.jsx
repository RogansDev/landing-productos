...
import Second from "../../../public/img/seccion-dos.jpg";
import Banner from "../../../public/img/getup-back.jpg";
import Expant from "../../../public/img/banner-ex.jpg";
import ScreenFirst from "../../../public/img/screenfirst.jpg";
import ScreenSecond from "../../../public/img/screensecond.jpg";
import ScreenThrid from "../../../public/img/screenThird.jpg";
  ...
  return (
    <div className="flex flex-col ">
      <div className="flex items-center mx-auto p-5 mb-4">
        <section className=" relative top-9 left-[9rem] flex flex-col w-[50%]">
          ...
          <article className="relative bottom-16">
            <h3 className="mb-2 text-gray-700">Suplemento vitamínico</h3>
            <h1 className="uppercase font-semibold tracking-wider text-secondary-40 text-5xl mb-2">
              Get up
            </h1>
      ...
      <div className="flex items-center relative left-[10rem] mb-2">
        ...
        <article className="w-[50%]">
          ...
          <p className="w-[25rem]">
            ...
            bienestar sexual de los hombres. Brinda una experiencia placentera y
            duradera, sin causar adicción u otras afecciones
          </p>
        </article>
      </div>
      {/* seccion de papaya */}
      <div className="mx-auto p-5 relative">
        ...
        <div>
          <p className="absolute top-[4rem] left-[46rem] text-white w-[40%] text-end">
            Descubre la solución natural que impulsa tu salud sexual y energía.
            Bienvenido a Get Up, el suplemento diseñado para hombres que buscan
            revitalizar su vida íntima y mejorar su bienestar general.
          </p>
          <h2 className="relative bottom-[8rem] left-[3rem] text-4xl text-white font-medium">
            Revitaliza tu vida <br /> Íntima con Get Up
          </h2>
        </div>
      </div>
      {/* seccion de fotos */}
