  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center font-poppins">
      <div className="relative bg-white p-2 rounded shadow-md">
        ...
        <section className="absolute left-[19rem] top-[15rem] text-white">
          ...
          <Link to="/Getup">
            <button
              onClick={onClose}
              className="flex items-center justify-center gap-4 bg-secondary-40 py-3 font-semibold text-white text-sm p-2 rounded-md w-[100%]"
            >
              <svg
                width="21"
                height="20"
