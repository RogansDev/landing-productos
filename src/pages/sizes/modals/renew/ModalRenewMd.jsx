...
import Banner from '../../../../../public/img-md/renew/modalrenewmd.png'
import { Link } from "react-router-dom";


const ModalRenewMd = ({onClose}) => {
      ...
      <div className="relative bg-white  p-2 rounded shadow-lg">
        ...
        <section className="absolute  top-[21rem] text-white">
          ...
          <Link to="/Renew">
            <button
              onClick={onClose}
              className="flex items-center justify-center relative left-5 gap-4 bg-primary-30 py-3 font-semibold text-white text-sm p-2 rounded-md w-[90%]"
            >
              <svg
                width="21"
                height="20"
