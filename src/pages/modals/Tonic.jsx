...
import Banner from '../../../public/img/tonic.jpg';

const TonicModal = ({onClose}) => {
      ...
      <div className="relative bg-white p-2 rounded shadow-md">
        ...
        <section>
          <img
            src={Banner}
            alt=""
            className="w-[40rem] h-[35rem] object-cover z-10"
          />
        </section>
        <section className="absolute left-[3rem] top-[15rem] text-white ">
          ...
          <Link to="/Tonic">
            <button
              onClick={onClose}
              className="flex items-center justify-center gap-4 bg-secondary-10 py-3 font-semibold text-black text-sm p-2 rounded-md w-[100%]"
            >
              <svg
                width="21"
                height="20"
